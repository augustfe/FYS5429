...
class PINN:
    ...
    def update_iteration(
        loss: Callable[[Params, dict], float],
        args: dict[str, Array],
        params: Params
        ...
        optimizer = jaxopt.LBFGS(lambda x : loss(x, args))

        optstate = optimizer.init_state(params)
        params, optstate = optimizer.update(params, optstate)
