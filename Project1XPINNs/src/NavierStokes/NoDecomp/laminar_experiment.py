...
# 
p0 = xpinn.PINNs[0]
p0.boundary_loss = boundary_loss_factory(inflow_func, nu=0.001, weights = (w_boundary, w_boundary,  w_boundary, w_boundary))
...
# Save model
our_model_path = model_path / "NavierStokes"/ "single_pinn"/ "laminar" /f"{file_train[:-5]}_{w_boundary}_{w_residual}_iterations={n_iter}_newsinglepinn"
