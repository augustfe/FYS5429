    ...
    def generate_data(self, num_points: List[Tuple[int, int]]):
        for count, region in enumerate(regions):
            if isinstance(region, ConvexPolygon):
                _generate_data_ConvexPoly(self.regions, num_points, self.all_points)
            else:
                _generate_data_Circle(self.regions, num_points, self.all_points)

    @staticmethod
    def _generate_data(regions: List[Shape], num_points: List[Tuple[int, int]], all_points):
        ...
        return all_points
    @staticmethod
    def generate_data_ConvexPoly(regions: List[Shape], num_points: List[Tuple[int, int]], all_data):
        
    @staticmethod
    def generate_data_Circle(regions: List[Shape], num_points: List[Tuple[int, int]], all_data):
