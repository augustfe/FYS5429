...
Thus, the problem defines a wave travelling rightwards without diffusion with a speed $\alpha$. The analytical solution also predicts two discontinuities. For our XPINN formulation, we decompose the domain according to the predicted discontinuities as in figure 
\begin{figure*}[t]
    % \centering
    \subfloat[PINN]{
    \includegraphics[width=0.48\textwidth]{Project1XPINNs/figures/Poisson/}
    \label{subfig:single}
    }
