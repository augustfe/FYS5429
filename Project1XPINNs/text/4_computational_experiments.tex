...
The PINN and XPINN solution, alongside their error, is also displayed in \autoref{fig:poisson_smooth}.
...
\begin{figure*}
\subfloat[PINN prediction]{
\includegraphics[width=0.48 \textwidth]{Project1XPINNs/figures/Poisson/PINN_Discrete.png}
}
\hfill
\subfloat[XPINN prediction]{
\includegraphics[width=0.48 \textwidth]{Project1XPINNs/figures/Poisson/XPINN1_Discrete.png}
}

\subfloat[PINN error]{
\includegraphics[width=0.48 \textwidth]{Project1XPINNs/figures/Poisson/PINN_error_Discrete.png}
}
\hfill
\subfloat[XPINN error]{
\includegraphics[width=0.48 \textwidth]{Project1XPINNs/figures/Poisson/XPINN1_error_Discrete.png}
}
